    ...
    if (empty($email)) {
        ...
        if ($result->num_rows == 1) {
            ...
            */
            ...
            /*
            |--------------------------------------------------------------------------
            | Remove previous unused reset records
            |--------------------------------------------------------------------------
            */
            ...
            */
            ...
            if (!$reset_stmt->execute()) {
                ...
                /*
                |--------------------------------------------------------------------------
                | Get newly created reset ID
                |--------------------------------------------------------------------------
                */

                $reset_id = $reset_stmt->insert_id;
                ...
                */
                ...
                $_SESSION['admin_reset_user_id'] = $row['id'];
                $_SESSION['admin_reset_email'] = $row['email'];
                $_SESSION['admin_reset_code'] = $verification_code;
                $_SESSION['admin_reset_code_time'] = time();
                $_SESSION['admin_reset_id'] = $reset_id;
                ...
                */
                ...
                try {
                    ...
                    */
                    ...
                    $mail->Password = 'eaeytezxtnrviqaa';
                    ...
                    $mail->Subject =
                        'PRMSU Administrator Password Reset Code';
                    ...
                    '>
                        ...
                        <p>
                            A password reset request was
                            made for your Administrator account.
                        </p>
                    ...
                    $mail->AltBody =
                        "Your PRMSU Administrator verification "
                        . "code is: "
                        . $verification_code
